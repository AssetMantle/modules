...
func Test_transactionKeeper_Transact(t *testing.T) {
	...
	keepers.IdentitiesKeeper.(transactionKeeper).mapper.NewCollection(context).Add(mappable.NewIdentity(defaultIdentityID, []sdkTypes.AccAddress{defaultAddr, provisionedAddr2, unprovisionedAddr},
