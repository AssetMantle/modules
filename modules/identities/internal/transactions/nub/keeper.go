...
func (transactionKeeper transactionKeeper) Transact(context sdkTypes.Context, msg sdkTypes.Msg) helpers.TransactionResponse {
	...
	nubIDProperty := base.NewMetaProperty(ids.NubID, base.NewMetaFact(base.NewIDData(message.NubID)))
	...
	authenticationProperty := base.NewMetaProperty(ids.Authentication, base.NewMetaFact(base.NewListData(base.NewAccAddressData(message.From))))
