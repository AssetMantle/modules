...
func (transactionKeeper transactionKeeper) Transact(context sdkTypes.Context, msg sdkTypes.Msg) helpers.TransactionResponse {
	...
	nubIDProperty := baseProperties.NewMetaProperty(constants.NubIDPropertyID.GetKey(), baseData.NewIDData(message.NubID))
	...
	authenticationProperty := baseProperties.NewMetaProperty(constants.AuthenticationPropertyID.GetKey(), baseData.NewListData(baseLists.NewDataList(baseData.NewAccAddressData(message.From))))
