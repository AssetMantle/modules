...
func newMessage(from sdkTypes.AccAddress, to sdkTypes.AccAddress, fromID types.ID, classificationID types.ID, immutableMetaProperties lists.MetaPropertyList, immutableProperties lists.PropertyList, mutableMetaProperties lists.MetaPropertyList, mutableProperties lists.PropertyList) sdkTypes.Msg {
	return message{
		From:                    from,
		To:                      to,
		FromID:                  fromID,
