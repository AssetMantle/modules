...
func Test_newTransactionRequest(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", args{fromAddress, testFromID.String(), testToID.String(), testClassificationID.String()}, &TransactionRequest{testBaseReq, testFromID.String(), testToID.String(), testClassificationID.String()}},
	}
