...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with zero NumberData", args{baseData.NewNumberData(0)}, errorConstants.IncorrectFormat},
		...
		{"+ve with negative NumberDataParam", args{baseTypes.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxProvisionAddressCount"), baseData.NewNumberData(-1)))}, errorConstants.IncorrectFormat},
		{"+ve with zero NumberDataParam", args{baseTypes.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxProvisionAddressCount"), baseData.NewNumberData(0)))}, errorConstants.IncorrectFormat},
