...
func (simulator) RandomizedGenesisState(simulationState *module.SimulationState) {
	...
	for i := range mappableList {
		...
		mappableList[i] = mappable.NewIdentity(baseSimulation.GenerateRandomID(simulationState.Rand), immutables, baseQualified.NewMutables(baseSimulation.GenerateRandomProperties(simulationState.Rand)))
	}
