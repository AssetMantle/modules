...
type maintainer struct {
	...
	MaintainedTraits types.Properties `json:"maintainedTraits" valid:"required field maintainedTraits missing"`
...
func (maintainer maintainer) MaintainsTrait(id types.ID) bool {
	for _, trait := range maintainer.MaintainedTraits.GetList() {
...
func NewMaintainer(ID types.ID, maintainedTraits types.Properties, addMaintainer bool, removeMaintainer bool, mutateMaintainer bool) mappables.Maintainer {
	return maintainer{
		ID:               ID,
