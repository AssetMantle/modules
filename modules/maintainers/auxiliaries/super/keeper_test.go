...
func Test_Auxiliary_Keeper_Help(t *testing.T) {
	...
	t.Run("PositiveCase", func(t *testing.T) {
		...
		if got := keepers.MaintainersKeeper.Help(context, NewAuxiliaryRequest(baseIDs.NewStringID("classificationID1"), baseIDs.NewStringID("identityID1"), baseLists.NewPropertyList())); !reflect.DeepEqual(got, want) {
	...
	t.Run("NegativeCase-Maintainer not present", func(t *testing.T) {
		t.Parallel()
		want := newAuxiliaryResponse(constants.EntityAlreadyExists)
