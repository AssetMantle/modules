...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with negative NumberDataParam", args{baseTypes.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxPropertyCount"), baseData.NewNumberData(-1)))}, errorConstants.IncorrectFormat},
