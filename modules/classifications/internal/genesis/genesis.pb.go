...
import (
	...
	mappable "github.com/persistenceOne/persistenceSDK/modules/classifications/internal/mappable"
	dummy "github.com/persistenceOne/persistenceSDK/modules/classifications/internal/parameters/dummy"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Genesis struct {
	DefaultMappableList  []mappable.Classification `protobuf:"bytes,1,rep,name=defaultMappableList,proto3" json:"defaultMappableList"`
	...
	MappableList         []mappable.Classification `protobuf:"bytes,3,rep,name=MappableList,proto3" json:"MappableList"`
...
var fileDescriptor_482e9ef79a2f0a3d = []byte{
	...
	,
}
...
func (m *Genesis) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DefaultMappableList = append(m.DefaultMappableList, mappable.Classification{})
		...
		case 3:
			...
			m.MappableList = append(m.MappableList, mappable.Classification{})
