...
func Test_ClassificationID_Methods(t *testing.T) {
	...
	require.NotPanics(t, func() {
		require.Equal(t, classificationID{ChainID: chainID, HashID: baseIDs.NewID(metaUtilities.Hash(metaUtilities.Hash("ID1"), metaUtilities.Hash("ID2"), baseTraits.Immutables{PropertyList: immutableProperties}.GenerateHashID().String()))}, testClassificationID)
		require.Equal(t, strings.Join([]string{chainID.String(), baseIDs.NewID(metaUtilities.Hash(metaUtilities.Hash("ID1"), metaUtilities.Hash("ID2"), baseTraits.Immutables{PropertyList: immutableProperties}.GenerateHashID().String())).String()}, constants.IDSeparator), testClassificationID.String())
