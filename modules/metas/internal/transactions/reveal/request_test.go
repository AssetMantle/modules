...
func Test_Reveal_Request(t *testing.T) {
	...
	msg2, error2 := newTransactionRequest(rest.BaseReq{From: "randomFromAddrs", ChainID: "test"}, metaFact).MakeMsg()
	require.NotNil(t, error2)
	require.Nil(t, msg2)

	msg2, error2 = newTransactionRequest(rest.BaseReq{From: fromAddress, ChainID: "test"}, "randomString").MakeMsg()
	require.NotNil(t, error2)
	require.Nil(t, msg2)
