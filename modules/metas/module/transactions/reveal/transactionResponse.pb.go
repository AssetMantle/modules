...
func (*TransactionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7ddaedcb2f4c228e, []int{0}
}
...
func (m *TransactionResponse) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func init() {
	proto.RegisterType((*TransactionResponse)(nil), "reveal.TransactionResponse")
}

func init() {
	proto.RegisterFile("modules/metas/module/transactions/reveal/transactionResponse.proto", fileDescriptor_7ddaedcb2f4c228e)
}

var fileDescriptor_7ddaedcb2f4c228e = []byte{
	...
	,
}
...
func (m *TransactionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Error) > 0 {
		i -= len(m.Error)
		copy(dAtA[i:], m.Error)
		i = encodeVarintTransactionResponse(dAtA, i, uint64(len(m.Error)))
		i--
		dAtA[i] = 0x12
	}
	if m.Success {
