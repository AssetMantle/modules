...
var (
	pattern_Transaction_Deputize_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"mantle", "assets", "deputize"}, "", runtime.AssumeColonVerbOpt(false)))
)
