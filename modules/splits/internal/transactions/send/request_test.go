...
func Test_Send_Request(t *testing.T) {
	...
	msg2, error2 := newTransactionRequest(rest.BaseReq{From: "randomFromAddrs", ChainID: "test"}, "fromID", "toID", "ownableID", "2").MakeMsg()
	require.NotNil(t, error2)
	require.Nil(t, msg2)

	msg2, error2 = newTransactionRequest(testBaseReq, "fromID", "toID", "ownableID", "randomString").MakeMsg()
	require.NotNil(t, error2)
	require.Nil(t, msg2)
