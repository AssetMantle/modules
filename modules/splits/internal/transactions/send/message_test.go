...
func Test_message_GetSignBytes(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{fromAccAddress, fromID, fromID, ownableID, testRate}, types.MustSortJSON(transaction.RegisterLegacyAminoCodec(messagePrototype).MustMarshalJSON(message{fromAccAddress, fromID, fromID, ownableID, testRate}))},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			message := message{
...
func Test_message_RegisterCodec(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{fromAccAddress, fromID, fromID, ownableID, testRate}, args{codec.NewLegacyAmino()}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			me := message{
