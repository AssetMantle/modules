...
func newTransactionRequest(baseReq rest.BaseReq, classificationID string, maintainersID string, properties string, lock int64, burn int64) utility.TransactionRequest {
	return transactionRequest{
		BaseReq:          baseReq,
