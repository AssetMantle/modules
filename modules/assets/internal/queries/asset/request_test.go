...
func Test_queryRequest_FromCLI(t *testing.T) {
	...
	tests := []struct {
		...
		// {"+ve", fields{testAssetID}, args{cliCommand, cliContext}, newQueryRequest(testAssetID), false},
		{"+ve", fields{baseIDs.PrototypeAssetID()}, args{cliCommand, cliContext}, newQueryRequest(baseIDs.PrototypeAssetID()), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			qu := queryRequest{
