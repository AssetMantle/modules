...
func Test_transactionRequest_FromCLI(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{testBaseRequest, fromID.String(), testAssetID.String()}, args{cliCommand, context}, newTransactionRequest(testBaseRequest, fromID.String(), testAssetID.String()), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
