...
func Test_Define_Request(t *testing.T) {
	...
	msg, Error = newTransactionRequest(rest.BaseReq{From: "randomFromAddress", ChainID: "test"}, "fromID", immutableMetaTraits, immutableTraits, mutableMetaTraits, mutableTraits).MakeMsg()
