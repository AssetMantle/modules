...
import (
	...
	properties2 "github.com/persistenceOne/persistenceSDK/constants/properties"
...
func (transactionKeeper transactionKeeper) Transact(context sdkTypes.Context, msg sdkTypes.Msg) helpers.TransactionResponse {
	...
	if metaProperties := base.NewMetaProperties(append(message.ImmutableMetaProperties.GetMetaPropertyList(), message.MutableMetaProperties.GetMetaPropertyList()...)); metaProperties.Get(base.NewID(properties2.Lock)) != nil {
		if split, Error = metaProperties.GetMetaProperty(base.NewID(properties2.Lock)).GetMetaFact().GetData().AsDec(); Error != nil {
