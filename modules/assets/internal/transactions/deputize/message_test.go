...
func Test_Deputize_Message(t *testing.T) {
	...
	require.Equal(t, Message{From: base.NewAccAddressFromSDKTypesAccAddress(fromAccAddress), FromID: testFromID, ToID: testToID, ClassificationID: testClassificationID, MaintainedProperties: maintainedProperties, AddMaintainer: false, RemoveMaintainer: false, MutateMaintainer: false}, testMessage)
