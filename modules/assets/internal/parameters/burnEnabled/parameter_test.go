...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with true booleanData", args{baseTypes.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("burnEnabled"), baseData.NewBooleanData(true)))}, nil},
		{"+ve with false booleanData", args{baseTypes.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("burnEnabled"), baseData.NewBooleanData(false)))}, nil},
