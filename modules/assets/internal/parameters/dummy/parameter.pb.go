...
// source: persistence_sdk/modules/assets/internal/parameters/dummy/parameter.proto
...
func (*DummyParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_778508db2e6703a7, []int{0}
}
...
func init() {
	proto.RegisterType((*DummyParameter)(nil), "persistence_sdk.modules.assets.internal.parameters.dummy.DummyParameter")
}

func init() {
	proto.RegisterFile("persistence_sdk/modules/assets/internal/parameters/dummy/parameter.proto", fileDescriptor_778508db2e6703a7)
}

var fileDescriptor_778508db2e6703a7 = []byte{
	...
	0x40, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x92, 0xb1, 0xd5, 0x6a, 0x0d, 0x02, 0x00, 0x00,
}
