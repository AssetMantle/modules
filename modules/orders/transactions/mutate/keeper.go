...
func (transactionKeeper transactionKeeper) Transact(context sdkTypes.Context, msg sdkTypes.Msg) error {
	...
	asset = mapper.NewOrder(asset.GetID(), assetStruct.BuyOrder, assetStruct.SellOrder, types.NewMutables(mutableProperties, asset.GetMaintainersID()), asset.GetImmutables(), asset.GetLock(), asset.GetBurn())
