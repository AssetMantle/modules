...
import (
	...
	mappable "github.com/persistenceOne/persistenceSDK/modules/orders/internal/mappable"
	dummy "github.com/persistenceOne/persistenceSDK/modules/orders/internal/parameters/dummy"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Genesis struct {
	DefaultMappableList  []mappable.Order       `protobuf:"bytes,1,rep,name=defaultMappableList,proto3" json:"defaultMappableList"`
	...
	MappableList         []mappable.Order       `protobuf:"bytes,3,rep,name=MappableList,proto3" json:"MappableList"`
...
var fileDescriptor_7dcbd95c78f6df33 = []byte{
	...
	,
}
...
func (m *Genesis) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DefaultMappableList = append(m.DefaultMappableList, mappable.Order{})
		...
		case 3:
			...
			m.MappableList = append(m.MappableList, mappable.Order{})
