...
func (queryKeeper queryKeeper) Order(ctx context.Context, request *QueryRequest) (*QueryResponse, error) {
	//TODO implement me
	panic("implement me")
}
...
func (queryKeeper queryKeeper) Enquire(context sdkTypes.Context, queryRequest helpers.QueryRequest) helpers.QueryResponse {
	return newQueryResponse(queryKeeper.mapper.NewCollection(context).Fetch(key.NewKey(queryRequestFromInterface(queryRequest).OrderID)), nil)
}
