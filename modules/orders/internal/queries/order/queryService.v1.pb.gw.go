...
var (
	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"mantle", "orders", "v1beta1", "order"}, "", runtime.AssumeColonVerbOpt(false)))
)
