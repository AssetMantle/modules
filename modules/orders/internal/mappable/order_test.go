...
func Test_Order_Methods(t *testing.T) {
	...
	takerIDImmutableProperty := base.NewProperty(ids.TakerID, base.NewFact(base.NewStringData("takerIDImmutableProperty")))
	exchangeRateImmutableProperty := base.NewMetaProperty(ids.ExchangeRate, base.NewMetaFact(base.NewDecData(sdkTypes.OneDec())))
	creationImmutableProperty := base.NewMetaProperty(ids.Creation, base.NewMetaFact(base.NewHeightData(base.NewHeight(100))))
	expiryImmutableProperty := base.NewProperty(ids.Expiry, base.NewFact(base.NewStringData("expiryImmutableProperty")))
	makerOwnableSplitImmutableProperty := base.NewProperty(ids.MakerOwnableSplit, base.NewFact(base.NewStringData("makerOwnableSplitImmutableProperty")))

	takerIDMutableProperty := base.NewProperty(ids.TakerID, base.NewFact(base.NewStringData("takerIDMutableProperty")))
	exchangeRateMutableProperty := base.NewProperty(ids.ExchangeRate, base.NewFact(base.NewDecData(sdkTypes.OneDec())))
	creationMutableProperty := base.NewProperty(ids.Creation, base.NewFact(base.NewHeightData(base.NewHeight(100))))
	expiryMutableProperty := base.NewProperty(ids.Expiry, base.NewFact(base.NewStringData("expiryMutableProperty")))
	makerOwnableSplitMutableProperty := base.NewProperty(ids.MakerOwnableSplit, base.NewFact(base.NewStringData("makerOwnableSplitMutableProperty")))
	...
	defaultTakerProperty := base.NewProperty(ids.TakerID, base.NewFact(data))
	defaultExchangeRateProperty := base.NewProperty(ids.ExchangeRate, base.NewFact(base.NewDecData(sdkTypes.OneDec())))
	data, _ = base.ReadHeightData("100")
	defaultCreationProperty := base.NewProperty(ids.Creation, base.NewFact(data))
	data, _ = base.ReadHeightData("-1")
	defaultExpiryProperty := base.NewProperty(ids.Expiry, base.NewFact(data))
	data, _ = base.ReadDecData("")
	defaultMakerOwnableSplitProperty := base.NewProperty(ids.MakerOwnableSplit, base.NewFact(data))
