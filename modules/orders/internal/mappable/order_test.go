...
func Test_Order_Methods(t *testing.T) {
	...
	takerIDImmutableProperty := base.NewProperty(ids.TakerIDProperty, base.NewFact(base.NewStringData("takerIDImmutableProperty")))
	exchangeRateImmutableProperty := base.NewMetaProperty(ids.ExchangeRateProperty, base.NewMetaFact(base.NewDecData(sdkTypes.OneDec())))
	creationImmutableProperty := base.NewMetaProperty(ids.CreationProperty, base.NewMetaFact(base.NewHeightData(base.NewHeight(100))))
	expiryImmutableProperty := base.NewProperty(ids.ExpiryProperty, base.NewFact(base.NewStringData("expiryImmutableProperty")))
	makerOwnableSplitImmutableProperty := base.NewProperty(ids.MakerOwnableSplitProperty, base.NewFact(base.NewStringData("makerOwnableSplitImmutableProperty")))

	takerIDMutableProperty := base.NewProperty(ids.TakerIDProperty, base.NewFact(base.NewStringData("takerIDMutableProperty")))
	exchangeRateMutableProperty := base.NewProperty(ids.ExchangeRateProperty, base.NewFact(base.NewDecData(sdkTypes.OneDec())))
	creationMutableProperty := base.NewProperty(ids.CreationProperty, base.NewFact(base.NewHeightData(base.NewHeight(100))))
	expiryMutableProperty := base.NewProperty(ids.ExpiryProperty, base.NewFact(base.NewStringData("expiryMutableProperty")))
	makerOwnableSplitMutableProperty := base.NewProperty(ids.MakerOwnableSplitProperty, base.NewFact(base.NewStringData("makerOwnableSplitMutableProperty")))
	...
	defaultTakerProperty := base.NewProperty(ids.TakerIDProperty, base.NewFact(data))
	defaultExchangeRateProperty := base.NewProperty(ids.ExchangeRateProperty, base.NewFact(base.NewDecData(sdkTypes.OneDec())))
	data, _ = base.ReadHeightData("100")
	defaultCreationProperty := base.NewProperty(ids.CreationProperty, base.NewFact(data))
	data, _ = base.ReadHeightData("-1")
	defaultExpiryProperty := base.NewProperty(ids.ExpiryProperty, base.NewFact(data))
	data, _ = base.ReadDecData("")
	defaultMakerOwnableSplitProperty := base.NewProperty(ids.MakerOwnableSplitProperty, base.NewFact(data))
