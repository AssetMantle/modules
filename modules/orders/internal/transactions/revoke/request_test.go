...
func Test_newTransactionRequest(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", args{fromAddress, testFromID.String(), testFromID.String(), testClassificationID.String()}, &TransactionRequest{testBaseRequest, testFromID.String(), testFromID.String(), testClassificationID.String()}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := newTransactionRequest(tt.args.From, tt.args.fromID, tt.args.toID, tt.args.classificationID); !reflect.DeepEqual(got, tt.want) {
...
func Test_transactionRequest_FromCLI(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{testBaseRequest, testFromID.String(), testFromID.String(), testClassificationID.String()}, args{cliCommand, context}, &TransactionRequest{testBaseRequest, testFromID.String(), testFromID.String(), testClassificationID.String()}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_transactionRequest_FromJSON(t *testing.T) {
	jsonMessage, err := json.Marshal(newTransactionRequest(fromAddress, testFromID.String(), testFromID.String(), testClassificationID.String()))
	...
	tests := []struct {
		...
		{"+ve", fields{testBaseRequest, testFromID.String(), testFromID.String(), testClassificationID.String()}, args{jsonMessage}, newTransactionRequest(fromAddress, testFromID.String(), testFromID.String(), testClassificationID.String()), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transactionRequest := TransactionRequest{
