...
func Test_Define_Request(t *testing.T) {
	...
	Codec.Seal()
	cliCommand := baseHelpers.NewCLICommand("", "", "", []helpers.CLIFlag{constants.FromID, constants.OrderID, constants.MakerOwnableSplit, constants.ExpiresIn, constants.TakerOwnableSplit, constants.MutableMetaProperties, constants.MutableProperties})
