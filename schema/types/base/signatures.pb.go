...
type Signatures struct {
	SignatureList []github_com_persistenceOne_persistenceSDK_schema_types.Signature `protobuf:"bytes,1,rep,name=signature_list,json=signatureList,proto3,customtype=github.com/persistenceOne/persistenceSDK/schema/types.Signature" json:"signature_list,omitempty"`
}
...
func init() {
	proto.RegisterType((*Signatures)(nil), "persistence_sdk.schema.types.base.Signatures")
}
...
var fileDescriptor_bfe86abedef3482d = []byte{
	...
	,
}
...
func (m *Signatures) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SignatureList) > 0 {
		for iNdEx := len(m.SignatureList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.SignatureList[iNdEx].Size()
				i -= size
...
func (m *Signatures) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_persistenceOne_persistenceSDK_schema_types.Signature
			m.SignatureList = append(m.SignatureList, v)
