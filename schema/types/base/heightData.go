...
func NewHeightData(value types.Height) *HeightData {
...
func (heightData HeightData) GenerateHashID() types.ID {
	...
	return NewTypeID(meta.Hash(strconv.FormatInt(heightData.Value.Get(), 10)))
}
...
func (heightData *HeightData) AsAny() (*codecTypes.Any, error) {
	return codecTypes.NewAnyWithValue(heightData)
}
