...
func init() {
	proto.RegisterType((*Properties)(nil), "persistence_sdk.schema.types.base.Properties")
}
...
var fileDescriptor_be58753e8e26787a = []byte{
	...
	,
}
...
func (m *Properties) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PropertyList) > 0 {
		for iNdEx := len(m.PropertyList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.PropertyList[iNdEx].Size()
				i -= size
...
func (m *Properties) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_persistenceOne_persistenceSDK_schema_types.Property
			m.PropertyList = append(m.PropertyList, v)
