...
func init() {
	proto.RegisterType((*HeightData)(nil), "base.HeightData")
}
...
var fileDescriptor_675e2f1db0d6c929 = []byte{
	...
	0x09, 0x2b, 0x29, 0x71, 0x71, 0x79, 0xc0, 0x65, 0x84, 0x44, 0xb8, 0x58, 0xcb, 0x12, 0x73, 0x4a,
	0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x98, 0x83, 0x20, 0x1c, 0xa7, 0x29, 0x8c, 0x27, 0x1e, 0xc9,
	...
	0x7f, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xd6, 0x1e, 0xb4, 0x6f, 0xec, 0x00, 0x00, 0x00,
}
...
func (m *HeightData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Value != 0 {
		i = encodeVarintHeightData(dAtA, i, uint64(m.Value))
		i--
		dAtA[i] = 0x8
	}
...
func (m *HeightData) Size() (n int) {
	...
	_ = l
	if m.Value != 0 {
		n += 1 + sovHeightData(uint64(m.Value))
	}
	return n
}
