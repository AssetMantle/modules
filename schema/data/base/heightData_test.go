...
import (
	...
	typesCosmosSdk "github.com/cosmos/cosmos-sdk/types"
...
func Test_heightData_GenerateHashID(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test for zero value", fields{baseTypes.NewHeight(0)}, baseIDs.GenerateHashID(heightData{baseTypes.NewHeight(0)}.Bytes())},
