...
func (*AnyOwnableID) Descriptor() ([]byte, []int) {
	return fileDescriptor_974c4254db28ae7f, []int{0}
}
...
func init() {
	proto.RegisterFile("schema/ids/base/anyOwnableID.v1.proto", fileDescriptor_974c4254db28ae7f)
}

var fileDescriptor_974c4254db28ae7f = []byte{
	...
	,
}
	...
	if m.AssetID != nil {
		{
			...
			i -= size
			i = encodeVarintAnyOwnableIDV1(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintAnyOwnableIDV1(dAtA []byte, offset int, v uint64) int {
	offset -= sovAnyOwnableIDV1(v)
	base := offset
	for v >= 1<<7 {
...
func (m *AnyOwnableID_AssetID) Size() (n int) {
	...
	if m.AssetID != nil {
		l = m.AssetID.Size()
		n += 1 + l + sovAnyOwnableIDV1(uint64(l))
	}
	return n
}
...
func sovAnyOwnableIDV1(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozAnyOwnableIDV1(x uint64) (n int) {
	return sovAnyOwnableIDV1(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *AnyOwnableID) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowAnyOwnableIDV1
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthAnyOwnableIDV1
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipAnyOwnableIDV1(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipAnyOwnableIDV1(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowAnyOwnableIDV1
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthAnyOwnableIDV1
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAnyOwnableIDV1
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthAnyOwnableIDV1        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowAnyOwnableIDV1          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupAnyOwnableIDV1 = fmt.Errorf("proto: unexpected end of group")
)
