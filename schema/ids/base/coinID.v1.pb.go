...
func init() { proto.RegisterFile("schema/ids/base/coinID.v1.proto", fileDescriptor_4f2e37f44a748cbb) }

var fileDescriptor_4f2e37f44a748cbb = []byte{
	// 254 bytes of a gzipped FileDescriptorProto
	,
	...
	if m.StringID != nil {
		{
			...
			i -= size
			i = encodeVarintCoinIDV1(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintCoinIDV1(dAtA []byte, offset int, v uint64) int {
	offset -= sovCoinIDV1(v)
	base := offset
	for v >= 1<<7 {
...
func sovCoinIDV1(x uint64) (n int) {
...
func (m *CoinID) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthCoinIDV1
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipCoinIDV1(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipCoinIDV1(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowCoinIDV1
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthCoinIDV1
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupCoinIDV1
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthCoinIDV1        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowCoinIDV1          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupCoinIDV1 = fmt.Errorf("proto: unexpected end of group")
)
