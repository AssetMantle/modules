...
func TestReadMetaProperties(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", args{"PropertyID:S|Data,ID1:S|Data1,ID2:S|Data2"}, base.NewPropertyList([]properties2.Property{baseProperties.NewMetaProperty(baseIds.NewStringID("PropertyID"), baseData.NewStringData("Data")), baseProperties.NewMetaProperty(baseIds.NewStringID("ID1"), baseData.NewStringData("Data1")), baseProperties.NewMetaProperty(baseIds.NewStringID("ID2"), baseData.NewStringData("Data2"))}...), false},
	}
