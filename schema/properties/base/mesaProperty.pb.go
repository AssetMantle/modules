...
func (m *MesaProperty) GetPropertyId() *base.PropertyID {
	if m != nil {
		return m.PropertyId
	}
	return nil
...
func (m *MesaProperty) GetData() *base1.Data {
	if m != nil {
		return m.Data
	}
	return nil
...
var fileDescriptor_a18241b6bd5ec330 = []byte{
	...
	0x31, 0xee, 0x01, 0x4e, 0xbe, 0xa9, 0x25, 0x89, 0x20, 0x77, 0xbd, 0x82, 0xc8, 0x24, 0xb1, 0x81,
	0x03, 0xc2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x9b, 0xa8, 0xf9, 0xb9, 0x7a, 0x01, 0x00, 0x00,
}
