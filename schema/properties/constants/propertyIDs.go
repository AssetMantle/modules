...
var (
	...
	IdentityIDProperty                 = baseIDs.NewPropertyID(baseIDs.NewStringID("IdentityIDProperty"), constants.IDDataID)
	LockProperty                       = baseIDs.NewPropertyID(baseIDs.NewStringID("lock"), constants.HeightDataID)
	MaintainedClassificationIDProperty = baseIDs.NewPropertyID(baseIDs.NewStringID("maintainedClassificationID"), constants.IDDataID)
