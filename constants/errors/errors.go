...
var (
	...
	EmptyFromAddress      = errors.Register(constants.ProjectRoute, 113, "EmptyFromAddress")
	EmptyDataCacheValue   = errors.Register(constants.ProjectRoute, 114, "EmptyDataCacheValue")
	InvalidDataCacheValue = errors.Register(constants.ProjectRoute, 115, "InvalidDataCacheValue")
)
