...
var (
	...
	SenderAddress       = base.NewCLIFlag("senderAddress", "", "SenderAddress")
	FeeRecipientAddress = base.NewCLIFlag("feeRecipientAddress", "", "FeeRecipientAddress")
	...
	MakerFee            = base.NewCLIFlag("makerFee", int64(0), "MakerFee")
	MakerFeeAssetData   = base.NewCLIFlag("makerFeeAssetData", "", "MakerFeeAssetData")
	...
	TakerFee            = base.NewCLIFlag("takerFee", int64(0), "TakerFee")
	TakerFeeAssetData   = base.NewCLIFlag("takerFeeAssetData", "", "TakerFeeAssetData")
	ExpirationTime      = base.NewCLIFlag("expirationTime", int64(0), "ExpirationTime")
