...
func TestAppImportExport(t *testing.T) {
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		{app.keys[distribution.StoreKey], newApp.keys[distribution.StoreKey], [][]byte{}},
		{app.keys[supply.StoreKey], newApp.keys[supply.StoreKey], [][]byte{}},
		{app.keys[params.StoreKey], newApp.keys[params.StoreKey], [][]byte{}},
		{app.keys[gov.StoreKey], newApp.keys[gov.StoreKey], [][]byte{}},
		{app.keys[wasm.StoreKey], newApp.keys[wasm.StoreKey], [][]byte{}},
		{app.keys[assets.Prototype().Name()], newApp.keys[assets.Prototype().Name()], [][]byte{}},
		{app.keys[classifications.Prototype().Name()], newApp.keys[classifications.Prototype().Name()], [][]byte{}},
		{app.keys[identities.Prototype().Name()], newApp.keys[identities.Prototype().Name()], [][]byte{}},
		{app.keys[maintainers.Prototype().Name()], newApp.keys[maintainers.Prototype().Name()], [][]byte{}},
		{app.keys[metas.Prototype().Name()], newApp.keys[metas.Prototype().Name()], [][]byte{}},
		{app.keys[orders.Prototype().Name()], newApp.keys[orders.Prototype().Name()], [][]byte{}},
		{app.keys[splits.Prototype().Name()], newApp.keys[splits.Prototype().Name()], [][]byte{}},
	}
...
// TODO: Make another test for the fuzzer itself, which just has noOp txs - from cosmos
