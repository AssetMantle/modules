...
func Test_auxiliaryRequestFromInterface(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", args{NewAuxiliaryRequest(testFromID, testFromID, testClassificationID, maintainedProperties, true, true, true, []ids.StringID{}...)}, auxiliaryRequest{testFromID, testFromID, testClassificationID, maintainedProperties, true, true, true, []ids.StringID{}}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
