...
func TestNewAuxiliaryRequest(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", args{testClassificationID, testFromID, mutables}, auxiliaryRequest{testClassificationID, testFromID, mutables}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewAuxiliaryRequest(tt.args.maintainedClassificationID, tt.args.identityID, tt.args.maintainedMutables)
