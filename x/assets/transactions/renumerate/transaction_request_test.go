...
func Test_transactionRequest_FromCLI(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{commonTransactionRequest, fromID.AsString(), testAssetID.AsString()}, args{cliCommand, client.Context{}.WithCodec(base.CodecPrototype())}, newTransactionRequest(commonTransactionRequest, fromID.AsString(), testAssetID.AsString()), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_transactionRequest_FromJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{commonTransactionRequest, fromID.AsString(), testAssetID.AsString()}, args{types.MustSortJSON(base.CodecPrototype().MustMarshalJSON(&Message{fromAccAddress.String(), fromID, testAssetID}))}, newTransactionRequest(commonTransactionRequest, fromID.AsString(), testAssetID.AsString()), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			transactionRequest := transactionRequest{
