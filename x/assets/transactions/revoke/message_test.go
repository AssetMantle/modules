...
func Test_message_GetSigners(t *testing.T) {
	tests := []struct {
		...
		{"valid", fields{fromAccAddress.String(), fromID, fromID, classificationID}, []sdkTypes.AccAddress{fromAccAddress}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			message := &Message{
...
func Test_message_ValidateBasic(t *testing.T) {
	tests := []struct {
		...
		{"valid", fields{fromAccAddress.String(), fromID, fromID, classificationID}, false},
		{"invalid", fields{}, true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_NewMessage(t *testing.T) {
	...
	tests := []struct {
		...
		{"nil inputs", args{fromID: baseIDs.PrototypeIdentityID(), toID: baseIDs.PrototypeIdentityID(), classificationID: baseIDs.PrototypeClassificationID()}, NewMessage(nil, baseIDs.PrototypeIdentityID(), baseIDs.PrototypeIdentityID(), baseIDs.PrototypeClassificationID())},
		{"valid", args{fromAccAddress, fromID, fromID, classificationID}, NewMessage(fromAccAddress, fromID, fromID, classificationID)},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
