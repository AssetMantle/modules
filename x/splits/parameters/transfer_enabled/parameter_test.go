...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"true boolean parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("transferEnabled"), baseData.NewBooleanData(true)))}, false},
		{"false boolean parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("transferEnabled"), baseData.NewBooleanData(false)))}, false},
