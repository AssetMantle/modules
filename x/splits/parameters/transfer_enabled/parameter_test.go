...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with true booleanData", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("transferEnabled"), baseData.NewBooleanData(true)))}, false},
		{"+ve with false booleanData", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("transferEnabled"), baseData.NewBooleanData(false)))}, false},
