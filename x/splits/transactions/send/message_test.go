...
func Test_message_Route(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", fields{fromAccAddress.String(), fromID, fromID, ownableID, testRate}, constants.ModuleName},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			message := &Message{
...
func Test_newMessage(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve", args{fromAccAddress, fromID, fromID, ownableID, testRate}, &Message{fromAccAddress.String(), fromID, fromID, ownableID, testRate}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
