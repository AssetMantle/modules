...
func validator(i interface{}) error {
	...
	case string:
		if number, err := baseData.PrototypeNumberData().FromString(value); err != nil {
			...
			return errorConstants.IncorrectFormat.Wrapf("incorrect format for maxProvisionAddressCount parameter, has to be a positive whole number", baseData.NewBooleanData(false), i)
		} else {
