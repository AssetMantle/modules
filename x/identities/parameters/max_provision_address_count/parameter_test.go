...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with positive NumberDataParam", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxProvisionAddressCount"), baseData.NewNumberData(math.ZeroInt())))}, true},
