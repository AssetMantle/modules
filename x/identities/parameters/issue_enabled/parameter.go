...
var ID = constantProperties.IssueEnabledProperty.GetKey()
...
func validator(i interface{}) error {
	...
	case string:
		...
		return err
	default:
		return errorConstants.IncorrectFormat.Wrapf("incorrect type for issueEnabled parameter, expected %s type as string, got %T", baseData.NewBooleanData(false).GetTypeID().AsString(), i)
	}
}
