...
func Test_message_GetSigners(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", fields{fromAccAddress.String(), testFromID, testOrderID}, []sdkTypes.AccAddress{fromAccAddress}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			message := &Message{
...
func Test_message_ValidateBasic(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", fields{fromAccAddress.String(), testFromID, testOrderID}, false},
		{"invalid", fields{}, true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_NewMessage(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid", args{fromAccAddress, testFromID, testOrderID}, &Message{fromAccAddress.String(), testFromID, testOrderID}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := NewMessage(tt.args.from, tt.args.fromID, tt.args.orderID)
