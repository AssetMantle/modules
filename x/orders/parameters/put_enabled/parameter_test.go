...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"true boolean parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("putEnabled"), baseData.NewBooleanData(true)))}, false},
		{"false boolean parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("putEnabled"), baseData.NewBooleanData(false)))}, false},
