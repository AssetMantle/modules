...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with true booleanData", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("putEnabled"), baseData.NewBooleanData(true)))}, false},
		{"+ve with false booleanData", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("putEnabled"), baseData.NewBooleanData(false)))}, false},
