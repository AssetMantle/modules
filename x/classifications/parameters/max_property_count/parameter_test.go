...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid positive number parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxPropertyCount"), baseData.NewNumberData(math.OneInt())))}, false},
		{"invalid negative number parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxPropertyCount"), baseData.NewNumberData(math.NewInt(-1))))}, true},
		{"zero number parameter", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("maxPropertyCount"), baseData.NewNumberData(math.ZeroInt())))}, true},
