...
func Test_validator(t *testing.T) {
	...
	tests := []struct {
		...
		{"+ve with zero NumberDataParam", args{baseParameters.NewParameter(baseProperties.NewMetaProperty(baseIDs.NewStringID("bondRate"), baseData.NewNumberData(math.ZeroInt())))}, true},
