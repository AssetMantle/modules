...
func TestAppImportExport(t *testing.T) {
	...
	prototype := base.NewSimulationApplication(applicationName, moduleBasicManager, moduleAccountPermissions, tokenReceiveAllowedModules).(*base.SimulationApplication)
