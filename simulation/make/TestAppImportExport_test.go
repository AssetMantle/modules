...
func TestAppImportExport(t *testing.T) {
	...
	newSimulationApplication := prototype.Initialize(logger, db, nil, true, simapp.FlagPeriodValue, map[int64]bool{}, prototype.GetDefaultHome()).(*base.SimulationApplication)
